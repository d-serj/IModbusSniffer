...
{
    if (event_queue[static_cast<size_t>(manager)].emptyQueue())
    {
        return;
    }

    event_queue[static_cast<size_t>(manager)].clearEvents();
}
